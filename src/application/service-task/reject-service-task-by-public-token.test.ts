...
import { RejectServiceTaskByPublicToken } from "./reject-service-task-by-public-token";
...
describe("RejectServiceTaskByPublicToken", () => {
  it("rejects a pending task for a valid public token", async () => {
    ...
    const useCase = new RejectServiceTaskByPublicToken(serviceTaskRepository, workOrderRepository);
