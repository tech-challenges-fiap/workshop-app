...
export interface ApproveServiceTaskInput {
  id: number;
  workOrderId?: number;
}

export type ApproveServiceTaskOutput = ReturnType<ServiceTask["toSnapshot"]>;

export class ApproveServiceTask {
  constructor(
    private readonly serviceTaskRepository: ServiceTaskRepository,
    private readonly workOrderRepository?: WorkOrderRepository,
  ) {}

  public async execute(input: ApproveServiceTaskInput): Promise<ApproveServiceTaskOutput> {
